...
if __name__ == "__main__":   
    ...
    functions_frame = Frame(guiWindow, bg = "#E9E4D4") 
    
    functions_frame.pack(side = "top", expand = True, fill = "both")  

    title_label = Label(functions_frame, text="HARSH BHARDWAJ", font=("Times New Roman", "12", "bold"), bg="#E9E4D4", fg="#B048B5")
    ...
    add_button =Button(  
        ...
        text = "Add",  
        width = 15,
        bg='#E1D9D1',font=("Palatino", "14", "bold"),
        command = add_task,
